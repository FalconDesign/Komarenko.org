...
langs_mobile.on('click',remove);
    ...
    function remove(e) {
      ...
      if ($this.hasClass('langs')) {
          $this.parent().hasClass('mobile_header') ? $this.toggleClass( 'active_mobile' ) : $this.toggleClass( 'active' );

      if ($this.hasClass('active')) {
          arrow_langs.attr('src', 'img/ico/micro_arrow_up.png');
        }
      else  if (!$this.hasClass('active')) {
            arrow_langs.attr('src', 'img/ico/micro_arrow_down.png');
          }
      else if($this.hasClass('active_mobile')) {
          arrow_langs_mobile.attr('src', 'img/ico/micro_arrow_up.png');

        } else if(!$this.hasClass('active_mobile')) {
            arrow_langs_mobile.attr('src', 'img/ico/micro_arrow_down.png');
          }
      else {
          arrow_langs.attr('src', 'img/ico/micro_arrow_down.png');
              }
               ...
               if ($this.hasClass('opened-currency')) {
                 arrow.attr('src', 'img/ico/micro_arrow_up.png');
                } else {
                    arrow.attr('src', 'img/ico/micro_arrow_down.svg');
                }
            }
